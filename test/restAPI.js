...
describe('REST Endpoint Tests', () => {
  ...
  describe('Root Controller', () => {
    it('checking root (/site/) w/o authorization', (done) => {
      request(svr)
        .get('/site/')
        .expect(401, done);
    });
  ...
  describe('Admin Controller Pre-Tests', () => {
    ...
    it('checking createSite POST (/site/admin/createSite)', (done) => {
      request(svr)
    ...
    it('checking updateSite POST (/site/admin/updateSite)', (done) => {
      request(svr)
    ...
    it('checking grantSitePermissions POST (/site/admin/grantSitePermissions)', (done) => {
      request(svr)
  ...
  describe('Dealer Controller', () => {
    it('checking dealer GET (/site/dealer) w/o dealerID', (done) => {
      request(svr)
        .get('/site/dealer')
        .query({ apiKey: testCreds.apiKey })
        .expect(400, done);
    });
    it('checking dealer GET (/site/dealer) w/ dealerID', (done) => {
      request(svr)
        .get('/site/dealer')
  ...
  describe('Vehicle Controller', () => {
    it('checking dealer GET (/site/vehilce/all) w/o dealerID', (done) => {
      request(svr)
        .get('/site/vehicle/all')
        .query({ apiKey: testCreds.apiKey })
        .expect(400, done);
    });
    it('checking dealer GET (/site/vehilce/all) w/ dealerID', (done) => {
      request(svr)
        .get('/site/vehicle/all')
        .query({ apiKey: testCreds.apiKey, dealerID: testDealer })
        .then((res) => {
    ...
    it('checking dealer GET (/site/vehilce/all) w/ dealerID and limit', (done) => {
      request(svr)
        .get('/site/vehicle/all')
    ...
    it('checking dealer GET (/site/vehicle) w/ vehicleID w/o dealerID', (done) => {
      request(svr)
        .get('/site/vehicle')
        .query({ apiKey: testCreds.apiKey, vehicleID: testVehicle })
        .expect(400, done);
    });
    it('checking dealer GET (/site/vehicle) w/ vehicleID w/ wrong dealerID', (done) => {
      request(svr)
        .get('/site/vehicle')
        .query({ apiKey: testCreds.apiKey, dealerID: testDealer + 1, vehicleID: testVehicle })
        .expect(403, done);
    });
    it('checking dealer GET (/site/vehicle) w/ vehicleID', (done) => {
      request(svr)
        .get('/site/vehicle')
  ...
  describe('Site Controller', () => {
    it('checking config GET (/site/config) w/ mismatched APIKey/SiteID', (done) => {
      request(svr)
        .get('/site/config')
        .query({ apiKey: badTestCreds.apiKey, siteID: targetSiteID })
        .expect(403, done);
    });
    it('checking config GET (/site/config) w/ good APIKey/SiteID', (done) => {
      request(svr)
        .get('/site/config')
    ...
    it('checking config GET (/site/config) updated info', (done) => {
      request(svr)
        .get('/site/config')
        .query({ apiKey: testCreds.apiKey, siteID: targetSiteID })
        .then((res) => {
  ...
  describe('Field Controller', () => {
    ...
    it('checking field DELETE (/site/config) w/ wrong security context', (done) => {
      request(svr)
        .delete('/site/field')
        .send({ apiKey: testCreds.apiKey, dealerID: testDealer, fieldLabel: 'TestField' })
        .expect(403, done);
    });
    it('checking field DELETE (/site/config)', (done) => {
      request(svr)
        .delete('/site/field')
        .send({ apiKey: testCreds.apiKey, secret: testCreds.secret, dealerID: testDealer, fieldLabel: 'TestField' })
        .expect(200, done);
  ...
  describe('Admin Controller Post-Tests', () => {
    it('checking revokeSitePermissions POST (/site/admin/revokeSitePermissions)', (done) => {
      request(svr)
    ...
    it('checking deleteSite POST (/site/admin/deleteSite)', (done) => {
      request(svr)
    ...
    it('checking deleteAPIKey POST (/site/admin/deleteAPIKey)', (done) => {
      request(svr)
        .post('/site/admin/createAPIKey')
    ...
    it('checking flushCache POST (/site/admin/flushCache)', (done) => {
      request(svr)
