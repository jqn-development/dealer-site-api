...
module.exports = function(app, controllers, log) {
  ...
  // Vehicles READ (*)
  app.get('/vehicle/\*', controllers.VehicleController.list.bind(controllers.VehicleController));
  app.get('/vehicle/\*/:page', controllers.VehicleController.list.bind(controllers.VehicleController));
