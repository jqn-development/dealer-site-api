...
class Vehicle {
  constructor(dbconn, logger) {
    ...
    this.model = dbconn.conn.define('vehicle', {
        ...
        priceRetail:              { type: sequelize.INTEGER(11), allowsNulls: true },
        priceInternet:            { type: sequelize.INTEGER(11), allowsNulls: true },
        priceWholesale:           { type: sequelize.INTEGER(11), allowsNulls: true },
        bookValue:                { type: sequelize.INTEGER(11), allowsNulls: true },
